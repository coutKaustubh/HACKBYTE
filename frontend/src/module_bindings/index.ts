...
const tablesSchema = __schema({
  ...
  ai_decision: __table({
    name: 'ai_decision',
    indexes: [
      { accessor: 'id', name: 'ai_decision_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'ai_decision_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, AiDecisionRow),
  execution: __table({
    name: 'execution',
  ...
  incident: __table({
    name: 'incident',
    indexes: [
      { accessor: 'id', name: 'incident_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
  ...
  safety_check: __table({
    name: 'safety_check',
    indexes: [
      { accessor: 'id', name: 'safety_check_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'safety_check_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, SafetyCheckRow),
  user: __table({
    name: 'user',
...
const reducersSchema = __reducers(
  __reducerSchema("add_ai_decision", AddAiDecisionReducer),
  __reducerSchema("add_safety_check", AddSafetyCheckReducer),
  ...
  __reducerSchema("start_execution", StartExecutionReducer),
);
