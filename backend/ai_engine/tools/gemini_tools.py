...
class GeminiTools:
    ...
    def stream_diagnose(self, logs: str, snapshot: dict, on_token) -> str:
        """Gets Gemini reasoning text, calls on_token(chunk) for each word.
        NOTE: Uses non-streaming call to avoid StopIteration bug in deprecated SDK."""
        prompt = f"""
