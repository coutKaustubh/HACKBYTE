...
const start_execution = spacetimedb.reducer({ incident_id: t.u64() }, (ctx, { incident_id }) => {
...
const resolve_incident = spacetimedb.reducer({ incident_id: t.u64() }, (ctx, { incident_id }) => {
	const inc = ctx.db.incident.id.find(incident_id);
	if (!inc) throw new SenderError("Incident not found");
